...
More information on the different fields in the metadata can be found in the [Tunnel documentation.](https://tunnel.khulnasoft.com/latest/docs/scanner/misconfiguration/custom/)
