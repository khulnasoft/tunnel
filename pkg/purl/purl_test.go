...
func TestPackageURL_Match(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			target:     "pkg:golang/github.com/khulnasoft/tunnel@v0.49.0",
			want:       true,
		},
		{
			name:       "different type",
		...
		},
		{
			...
			constraint: "pkg:golang/github.com/khulnasoft/tunnel@v0.49.0",
			target:     "pkg:golang/github.com/khulnasoft/tunnel@v0.49.1",
			want:       false,
		},
		{
			name:       "version wildcard",
			constraint: "pkg:golang/github.com/khulnasoft/tunnel",
			target:     "pkg:golang/github.com/khulnasoft/tunnel@v0.50.0",
			want:       true,
		},
		{
