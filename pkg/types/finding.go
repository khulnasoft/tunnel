...
const (
	...
	FindingStatusIgnored            FindingStatus = "ignored"             // Tunnel
	FindingStatusUnknown            FindingStatus = "unknown"             // Tunnel
...
// Finding represents one of the findings that Tunnel can detect,
...
// such as .tunnelignore and VEX. Currently, it is primarily used to account for vulnerabilities
// that are ignored via .tunnelignore or identified as not impactful through VEX.
