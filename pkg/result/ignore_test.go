...
func TestParseIgnoreFile(t *testing.T) {
	t.Run("happy path valid config file", func(t *testing.T) {
		got, err := ParseIgnoreFile(t.Context(), "testdata/.tunnelignore")
	...
	t.Run("happy path valid YAML config file", func(t *testing.T) {
		got, err := ParseIgnoreFile(t.Context(), "testdata/.tunnelignore.yaml")
		require.NoError(t, err)
	...
	t.Run("invalid file passed", func(t *testing.T) {
		...
		_, err = f.WriteString("this file is not a valid tunnelignore file")
		require.NoError(t, err)
