					...
					Misconfigurations: []types.DetectedMisconfiguration{
						{
							...
							Status:      types.MisconfStatusFailure,
							PrimaryURL:  "https://avd.khulnasoft.com/misconfig/ds002",
							References:  []string{"https://avd.khulnasoft.com/misconfig/ds002"},
							CauseMetadata: ftypes.CauseMetadata{
								Provider: "Dockerfile",
								Service:  "general",
								Code:     ftypes.Code{},
						...
						},
						{
							...
							PrimaryURL: "https://avd.khulnasoft.com/misconfig/ds001",
							References: []string{"https://avd.khulnasoft.com/misconfig/ds001"},
						},
					},
				},
			},
