    ...
    {{- end}}
        {
            ...
            "GeneratorId": "Tunnel/{{ .VulnerabilityID }}",
            ...
            "Title": "Tunnel found a vulnerability to {{ .VulnerabilityID }} in container {{ $target }}, related to {{ .PkgName }}",
            ...
            {{ end -}}
            "ProductFields": { "Product Name": "Tunnel" },
            "Resources": [
                {
                    "Type": "Container",
                    "Id": "{{ $target }}",
            ...
            {{- end -}}
        {
            ...
            "Title": "Tunnel found a secret in {{ $target }}: {{ .Title }}",
            "Description": "Tunnel found a secret in {{ $target }}: {{ .Title }}",
            "ProductFields": { "Product Name": "Tunnel" },
            "Resources": [
                {
                    "Type": "Other",
