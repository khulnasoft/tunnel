						...
						Packages: types.Packages{
							{
								...
								Relationship: types.RelationshipRoot,
								DependsOn: []string{
									"github.com/khulnasoft/de-parser@v1.0.0",
							...
							{
								ID:           "github.com/khulnasoft/de-parser@v1.0.0",
								Name:         "github.com/khulnasoft/de-parser",
								Version:      "v1.0.0",
								Relationship: types.RelationshipDirect,
								ExternalReferences: []types.ExternalRef{
						...
						Packages: types.Packages{
							{
								...
								Relationship: types.RelationshipRoot,
								DependsOn: []string{
									"github.com/khulnasoft/de-parser@v0.0.0-20230219131432-590b1dfb6edd",
								},
								ExternalReferences: []types.ExternalRef{
									{
										Type: types.RefVCS,
							...
							{
								ID:           "github.com/khulnasoft/de-parser@v0.0.0-20230219131432-590b1dfb6edd",
								Name:         "github.com/khulnasoft/de-parser",
