...
func (p *Parser) Parse(r xio.ReadSeekerAt) ([]ftypes.Package, []ftypes.Dependency, error) {
	...
	if info.Main.Path != "" {
		...
		// See https://github.com/khulnasoft/tunnel/issues/1837#issuecomment-1832523477.
...
// See more in https://github.com/khulnasoft/tunnel/issues/6702#issuecomment-2122271427
...
func isVersionXKey(key string) bool {
	...
	// The check for a 'ver' prefix enables the parser to pick up Tunnel's own version value that's set.
...
// e.g.
//   - `github.com/khulnasoft/tunnel/pkg/version/app.ver` => `version`
//   - `github.com/google/go-containerregistry/cmd/crane/common.ver` => `common`
func versionPrefix(s string) string {
	// Trim module part.
	// e.g. `github.com/khulnasoft/tunnel/pkg/Version.version` => `Version.version`
