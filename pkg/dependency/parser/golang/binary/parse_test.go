...
func TestParse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantPkgs: []ftypes.Package{
				{
					ID:           "github.com/ebati/tunnel-mod-parse",
					Name:         "github.com/ebati/tunnel-mod-parse",
					Version:      "",
					Relationship: ftypes.RelationshipRoot,
				},
				{
	...
	}{
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/khulnasoft/tunnel/pkg/version/app.ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/khulnasoft/tunnel/pkg/version.Version=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		...
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='github.com/khulnasoft/tunnel/pkg/version.Ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
