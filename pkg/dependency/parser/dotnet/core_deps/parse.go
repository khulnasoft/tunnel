...
func (p *Parser) Parse(r xio.ReadSeekerAt) ([]ftypes.Package, []ftypes.Dependency, error) {
	...
	for nameVer, lib := range depsFile.Libraries {
		...
		if targetLibs, ok := depsFile.Targets[depsFile.RuntimeTarget.Name]; !ok {
			...
			// cf. https://github.com/khulnasoft/tunnel/pull/7039#discussion_r1674566823
			continue
		}
...
// See https://github.com/khulnasoft/tunnel/discussions/4282#discussioncomment-8830365 for more details.
