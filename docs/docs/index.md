...
This documentation details how to use Tunnel to access the features listed below.
...
- Fast
    ...
    - Unlike other scanners that take long to fetch vulnerability information (~10 minutes) on the first run, and encourage you to maintain a durable vulnerability database, Tunnel is stateless and requires no maintenance or preparation.
- Easy installation
...
Please see [LICENSE][license] for Tunnel licensing information.
