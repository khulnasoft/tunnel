...
func TestUserAgents(t *testing.T) {
	...
	ok := tracker.agents.Contains(fmt.Sprintf("tunnel/%s go-containerregistry", app.Version()))
	require.True(t, ok, `user-agent header equals to "tunnel/dev go-containerregistry"`)
}
