...
import (
	...
	"github.com/khulnasoft/tunnel/pkg/sbom"
...
func (a sbomAnalyzer) Analyze(ctx context.Context, input analyzer.AnalysisInput) (*analyzer.AnalysisResult, error) {
	...
	// cf. https://github.com/khulnasoft/tunnel/issues/8324
	...
	// - overwrite applications when merging layers. See https://github.com/khulnasoft/tunnel/issues/7851
	// - show FilePath as Target of Application. See https://github.com/khulnasoft/tunnel/issues/8189.
