...
```
tunnel repository [flags] (REPO_PATH | REPO_URL)
```
...
```
      ...
      --checks-bundle-repository string   OCI registry URL to retrieve checks bundle from (default "mirror.gcr.io/khulnasoft/tunnel-checks:1")
  ...
  -o, --output string                     output file name
      ...
      --secret-config string              specify a path to config file for secret scanning (default "tunnel-secret.yaml")
