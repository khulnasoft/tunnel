...
func (o *OS) Merge(newOS OS) {
	...
	//   - Cache contains a layer derived from an old version of Tunnel.
	//   - `client` uses an old version of Tunnel, but `server` is a new version of Tunnel (for `client/server` mode).
