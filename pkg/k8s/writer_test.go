					...
					Vulnerabilities: []types.DetectedVulnerability{
						{
							...
							FixedVersion:     "v0.0.2",
							PrimaryURL:       "https://avd.khulnasoft.com/nvd/cve-2022-1111",
							Vulnerability:    dbTypes.Vulnerability{Severity: "LOW"},
						},
					},
				},
...
├─────────┼───────────────┼──────────┼─────────┼───────────────────┼───────────────┼───────────────────────────────────────────┤
│ foo/bar │ CVE-2022-1111 │ LOW      │ unknown │ v0.0.1            │ v0.0.2        │ https://avd.khulnasoft.com/nvd/cve-2022-1111 │
└─────────┴───────────────┴──────────┴─────────┴───────────────────┴───────────────┴───────────────────────────────────────────┘`,
		},
		{
...
Severities: C=CRITICAL H=HIGH M=MEDIUM L=LOW U=UNKNOWN`,
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			t.Setenv("TUNNEL_DISABLE_VEX_NOTICE", "true")
			output := bytes.Buffer{}
