...
| Feature | Tunnel OSS | Khulnasoft |
| --- | --- | --- |
| Infrastructure as Code (IaC) | Many popular languages as detailed [here](https://tunnel.khulnasoft.com/latest/docs/scanner/misconfiguration/policy/builtin/) | In addition, Build Pipeline configuration scanning |
