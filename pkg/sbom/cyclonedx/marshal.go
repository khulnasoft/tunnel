...
import (
	...
	sbomio "github.com/khulnasoft/tunnel/pkg/sbom/io"
...
type Marshaler struct {
	appVersion   string // Tunnel version
	bom          *core.BOM
...
// MarshalReport converts the Tunnel report to the CycloneDX format
...
// Marshal converts the Tunnel component to the CycloneDX format
...
// componentType converts the Tunnel component type to the CycloneDX component type
...
func (*Marshaler) advisories(refs []string) *[]cdx.Advisory {
	...
	advs := lo.FilterMap(refs, func(ref string, _ int) (cdx.Advisory, bool) {
		...
		// cf. https://github.com/khulnasoft/tunnel/issues/6801
...
// severity converts the Tunnel severity to the CycloneDX severity
