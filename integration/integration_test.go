...
import (
	...
	"github.com/khulnasoft/tunnel/pkg/vex/repo"
...
func initVEXRepository(t *testing.T, homeDir, cacheDir string) {
	...
	configDst := filepath.Join(homeDir, ".tunnel", "vex", "repository.yaml")
...
// runTest runs Tunnel with the given args and compares the output with the golden file.
